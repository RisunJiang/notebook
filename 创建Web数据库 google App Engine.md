...
-   测试您的应用是否在网络上运行。在浏览器中输入 **_myapp_.appspot.com**，仅用您的Application Identifer 替换 “_myapp_”。该应用程序应与您在本地测试服务器上运行时的外观相同。只到现在，它才能真的上网了，您可以从App Inventor for Android应用程序访问它。
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbNTUyODU5NzM4LDQzMTYyODg3OSwtMTk4Nj
