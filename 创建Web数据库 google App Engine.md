...
-   选择 **Create an Application** 创建应用程序。您需要指定全局唯一的**Application Identifer** (应用程序标识符)。记住Application Identifer，稍后您将需要它。为您的应用程序提供名称，然后单击 **Create Application to submit** “创建应用程序”以进 如果您的标识符是唯一的，那么您现在在Google服务器上有一个新的空白应用。
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbNzgyMjU4MTAxLDQzMTYyODg3OSwtMTk4Nj
