...
-   下载 [sample web database code](http://sites.google.com/site/appinventor/sample-tinywebdb-services/appinventordb.zip?attredirects=0&d=1)。它是一个zip文件，包含自定义Web source code。
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE1OTcyNTYwOTAsMTc5OTMzMTg4OSw3Mz
A5OTgxMTZdfQ==
-->