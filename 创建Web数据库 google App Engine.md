...
-   在**GoogleAppEngineLauncher**中，选择“文件”| 添加现有应用程序 浏览以设置您刚刚解压缩的appinventordb文件夹的路径。然后单击“运行”按钮。这将启动在本地计算机上运行的测试Web服务。
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTEwMTYxMTI5MywxNzk5MzMxODg5LDczMD
k5ODExNl19
-->