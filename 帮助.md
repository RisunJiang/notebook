...
您可以从打开文件**Google Drive**，** Dropbox的**或 ** GitHub的**通过打开**同步打开文件，方法是打开**Synchronize**子菜单，然后点击**从打开Open from**。在工作区中打开后，文件中的任何修改都将自动同步。
...
F0ZTogJzIwMTgtMDgtMTUnXG4iLCJoaXN0b3J5IjpbLTE2ODUw
NzE1NjksLTMxMjg4MTY1NywxNTI5MzIzNTYxLDExMTY0MDM0Mj
VdfQ==
-->