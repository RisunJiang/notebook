...
由于一个文件可以被发布到多个位置，你可以列出和管理通过点击发布位置**File publication**的**发布**子菜单。这允许您列出和删除链接到您的文件的发布位置。
...
F0ZTogJzIwMTgtMDgtMTUnXG4iLCJoaXN0b3J5IjpbLTQ1MDgx
MjczOCwyNDkwMzYwMjMsLTE2ODA1MjU3NTYsLTE1NTcwMDk3Mz
